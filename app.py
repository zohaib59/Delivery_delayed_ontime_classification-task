...
data = pd.read_csv("delivery.csv",encoding='Latin1')
...
data.boxplot(column=["avg_speed_kmph"])

data = pintu(data,"avg_speed_kmph")


##To check the data distribution 

def class_distribution(data, column_name='is_delayed'):
...
class_distribution(data, 'is_delayed')
